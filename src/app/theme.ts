...
export const customTheme: CustomFlowbiteTheme = createTheme({
	button: {
		...
		color: {
			primary:
				"bg-primary text-white hover:bg-primary/80 focus:ring-primary/50 dark:bg-primary dark:hover:bg-primary/80 dark:focus:ring-primary/30",
			secondary:
				"bg-secondary text-white hover:bg-secondary/80 focus:ring-secondary/50 dark:bg-secondary dark:hover:bg-secondary/80 dark:focus:ring-secondary/30",
			accent:
				"bg-accent text-white hover:bg-accent/80 focus:ring-accent/50 dark:bg-accent dark:hover:bg-accent/80 dark:focus:ring-accent/30",
			highlight:
				"bg-highlight text-white hover:bg-highlight/80 focus:ring-highlight/50 dark:bg-highlight dark:hover:bg-highlight/80 dark:focus:ring-highlight/30",
		},
		outlineColor: {
			primary:
				"border border-primary text-primary hover:border-primary/80 hover:bg-primary hover:text-white focus:ring-primary/50 dark:border-primary dark:text-primary dark:hover:bg-primary dark:hover:text-white dark:focus:ring-primary/30",
			secondary:
				"border border-secondary text-secondary hover:border-secondary/80 hover:bg-secondary hover:text-white focus:ring-secondary/50 dark:border-secondary dark:text-secondary dark:hover:bg-secondary dark:hover:text-white dark:focus:ring-secondary/30",
			accent:
				"border border-accent text-accent hover:border-accent/80 hover:bg-accent hover:text-white focus:ring-accent/50 dark:border-accent dark:text-accent dark:hover:bg-accent dark:hover:text-white dark:focus:ring-accent/30",
			highlight:
				"border border-highlight text-highlight hover:border-highlight/80 hover:bg-highlight hover:text-white focus:ring-highlight/50 dark:border-highlight dark:text-highlight dark:hover:bg-highlight dark:hover:text-white dark:focus:ring-highlight/30",
		},
	},
	badge: {
		root: {
	...
	checkbox: {
		color: {
			...
			secondary:
				"text-secondary focus:ring-secondary dark:ring-offset-gray-800 dark:focus:ring-secondary",
			accent:
				"text-accent focus:ring-accent dark:ring-offset-gray-800 dark:focus:ring-accent",
			highlight:
				"text-highlight focus:ring-highlight dark:ring-offset-gray-800 dark:focus:ring-highlight",
		},
	},
	toggleSwitch: {
		toggle: {
